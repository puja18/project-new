...
public interface IAccountService {
         ...
         /* public AccountBean findAccount(String phoneNo) throws Exception;*/
		  ...
		  boolean validations(AccountBean accountBean) throws CustomerException;
		 AccountBean findAccount(int accId, String phoneNo) throws Exception;
